 ...
 * 
 * EX 3
 * Write a function using destructuring syntax to extract the value of title, author for each book
...
function findBookSDetail(books){
	for (let booksUrl of books.entries()) {
		console.log({title, booksUrl:url});
	}
}
findBookSDetail(books);